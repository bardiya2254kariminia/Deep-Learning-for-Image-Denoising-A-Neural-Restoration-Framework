...
class Add_noise_transform:
    ...
    def __call__(self,image : torch.Tensor):
        ...
        if noise_type == "gaussian":
            ...
            noise_type = torch.clamp(self=noise_type , max=1 , min=0)
            return noisy_image
...
if __name__ == "__main__":
    ...
    img = Image.open(rf"/home/bardiya/projects/ai-side-projects/Deep-Learning-for-Image-Denoising-A-Neural-Restoration-Framework/img.jpeg")
    out = tr(img)
    out.save("out.jpg")